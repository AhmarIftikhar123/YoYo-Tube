...
<body>
                              ...
                              <div class="col-md-8">
                                        ...
                                        <div class="mb-4">
                                                  ...
                                                  <p id="videoDescription" class="mb-2">
                                                            <?= htmlspecialchars($this->current_video_info['description']) ?? "" ?></p>
                                                  <p><strong>Category:</strong> <span
                                                                      id="videoCategory"><?= htmlspecialchars($this->current_video_info['category']) ?? "" ?></span>
                                                  </p>
                                                  <p><strong>Tags:</strong> <span id="videoTags"><?php if (isset($tags)) {
                                                            foreach ($tags as $tag) {
                                                                      echo $tag . " ";
                                                            }
                                                  } ?></span></p>
          ...
          <script>
                    $(document).ready(function () {
                              ...
                              const relatedVideos = [
                                        { title: 'Advanced YoYo Techniques', thumbnail: 'https://via.placeholder.com/150' },
                                        { title: 'YoYo Competition Highlights', thumbnail: 'https://via.placeholder.com/150' },
                                        { title: 'Beginner YoYo Tutorial', thumbnail: 'https://via.placeholder.com/150' },
                                        { title: 'YoYo Trick Compilation', thumbnail: 'https://via.placeholder.com/150' }
                              ];
